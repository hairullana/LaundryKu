...
<body>
    ...
    <div id="body">
        <h3>STATUS CUCIAN</h3>
        <?php if ($login == "Admin") : $query = mysqli_query($connect, "SELECT * FROM cucian"); ?>
        ...
        <?php elseif ($login == "Agen") : $query = mysqli_query($connect, "SELECT * FROM cucian WHERE id_agen = $idAgen"); ?>
            <table border=1 cellpadding=10>
                <tr>
                    <td>ID Cucian</td>
                    <td>Pelanggan</td>
        ...
        <?php elseif ($login == "Pelanggan") : $query = mysqli_query($connect, "SELECT * FROM cucian WHERE id_pelanggan = $idPelanggan"); ?>
            <table border=1 cellpadding=10>
                <tr>
                    <td>ID Cucian</td>
                    <td>Agen</td>
